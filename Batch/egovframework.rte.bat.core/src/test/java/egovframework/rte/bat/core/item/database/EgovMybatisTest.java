...
@ContextConfiguration(locations = { "/egovframework/batch/batch-runner-context.xml", 
									"/egovframework/batch/context-mybatis.xml", 
									"/egovframework/batch/jobs/mybatisJob.xml" })
