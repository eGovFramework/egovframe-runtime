...
import org.egovframe.rte.bat.config.jobs.EventNoticeTriggerJob;
...
@ContextConfiguration(classes = EventNoticeTriggerJob.class)
public class EgovEventNoticeTriggerJobFunctionalTests extends EgovAbstractIoSampleTests {
