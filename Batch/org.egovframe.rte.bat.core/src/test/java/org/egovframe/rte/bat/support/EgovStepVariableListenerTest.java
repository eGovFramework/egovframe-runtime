...
import org.egovframe.rte.bat.config.jobs.DelimitedToDelimitedJobStepVariable;
...
/**
 * EgovStepVariableListener JUnit Test 클래스
 *
 * @author 장동한
 * @version 1.0
 * @see <pre>
...
@ContextConfiguration(classes = DelimitedToDelimitedJobStepVariable.class)
public class EgovStepVariableListenerTest {
    ...
    public void testJobRun() throws Exception {
        ...
        String jobName = "delimitedToDelimitedJob-StepVariable";
        ...
        //Step Variable 확인
        assertEquals("StepVariableValue1", System.getProperty("system.stepVariable1"));
