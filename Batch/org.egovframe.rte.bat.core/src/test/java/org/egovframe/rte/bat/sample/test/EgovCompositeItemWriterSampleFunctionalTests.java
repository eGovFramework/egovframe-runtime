...
import org.egovframe.rte.bat.config.jobs.CompositeItemWriterSampleJob;
...
@ContextConfiguration(classes = {CompositeItemWriterSampleJob.class})
public class EgovCompositeItemWriterSampleFunctionalTests {
    ...
    public void testJobLaunch() throws Exception {
        ...
        int before = jdbcTemplate.queryForObject("SELECT COUNT(*) from TRADE", new Object[]{}, Integer.class);
    ...
    private void checkOutputTable(int before) {
        ...
        int after = jdbcTemplate.queryForObject("SELECT COUNT(*) from TRADE", new Object[]{}, Integer.class);
        assertEquals(before + 5, after);

        jdbcTemplate.query(GET_TRADES,
                new Object[]{},
                new RowMapper<>() {
