 ...
 * EgovEmailEventNoticeTrigger 를 사용 현재 Sms 서비스는 별도 신청후 사용하는 시스템이므로 Sample 에서는
...
public class EgovEventNoticeCallProcessor<T, S> extends EgovStepPostProcessor<T, S> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(EgovEventNoticeCallProcessor.class);

    @Resource(name = "emailEventNoticeTrigger")
    private EgovEmailEventNoticeTrigger egovEmailEventNoticeTrigger;
