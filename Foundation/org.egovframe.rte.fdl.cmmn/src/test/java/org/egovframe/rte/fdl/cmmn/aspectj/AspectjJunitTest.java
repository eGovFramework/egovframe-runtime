...
public class AspectjJunitTest {
	...
	public void testSampleService() {
		//assertEquals("class org.egovframe.rte.fdl.cmmn.aspectj.SampleServiceImpl",this.sampleService.getClass().toString());
		assertTrue(this.sampleService.getClass().toString().contains("class org.egovframe.rte.fdl.cmmn.aspectj.SampleServiceImpl"));
