...
public class SampleAspect {
    ...
    public void beforeTargetMethod(JoinPoint thisJoinPoint) {
        ...
        LOGGER.debug("### SampleAspect beforeTargetMethod() execution({} {}())", className, methodName);
    }
    ...
    public void Pointcut(JoinPoint thisJoinPoint) {
        String className = thisJoinPoint.getTarget().getClass().getSimpleName();
        String methodName = thisJoinPoint.getSignature().getName();
        LOGGER.debug("### SampleAspect Pointcut() execution({} {}())", className, methodName);
    }
    ...
    public Object aroundTargetMethod(ProceedingJoinPoint thisJoinPoint) throws Throwable {
        String className = thisJoinPoint.getTarget().getClass().getSimpleName();
        String methodName = thisJoinPoint.getSignature().getName();
        LOGGER.debug("### SampleAspect aroundTargetMethod() execution({} {}())", className, methodName);
