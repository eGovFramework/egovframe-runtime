...
import org.egovframe.rte.fdl.cmmn.config.ExceptionResolverConfig;
...
@ContextConfiguration(classes = ExceptionResolverConfig.class)
public class SimpleMappingExceptionResolverTest {
    ...
    public void setUp() {
        ...
        exceptionResolver.setExceptionAttribute(SimpleMappingExceptionResolver.DEFAULT_EXCEPTION_ATTRIBUTE);
    ...
    public void testTwoMappings() {
        ...
        props.setProperty("org.egovframe.rte.bsl.exception.web.ExceptionCase1", "common/exceptionViewCase1");
        props.setProperty("org.egovframe.rte.bsl.exception.web.ExceptionCase2", "common/exceptionViewCase2");
