...
public class EgovExcelServiceTest {
    ...
    public void testWriteExcelFile() throws IOException {
        LOGGER.debug("### EgovExcelServiceTest testWriteExcelFile() Start ");
        ...
        LOGGER.debug("### EgovExcelServiceTest testWriteExcelFile() End ");
    }
    ...
    public void testModifyCellContents() throws IOException {
        LOGGER.debug("### EgovExcelServiceTest testModifyCellContents() Start ");
        ...
        // 엑셀 파일 로드
        Workbook workbook2 = excelService.loadWorkbook(sb.toString());
        ...
        LOGGER.debug("### EgovExcelServiceTest testModifyCellContents() End ");
    }
    ...
    public void testWriteExcelFileAttribute() throws IOException {
        LOGGER.debug("### EgovExcelServiceTest testWriteExcelFileAttribute() Start ");
        ...
        hssfCellStyle.setAlignment(HorizontalAlignment.RIGHT); // 정렬
        hssfCellStyle.setFillPattern(FillPatternType.DIAMONDS); // 무늬 스타일
        hssfCellStyle.setFillForegroundColor(IndexedColors.BLUE.getIndex()); // 무늬 색
        hssfCellStyle.setFillBackgroundColor(IndexedColors.RED.getIndex()); // 배경색
        sheet.setDefaultColumnStyle((short) 0, hssfCellStyle);
        ...
        LOGGER.debug("### EgovExcelServiceTest testWriteExcelFileAttribute() End ");
    }
    ...
    public void testModifyDocAttribute() throws IOException {
        LOGGER.debug("### EgovExcelServiceTest testModifyDocAttribute() Start ");
        ...
        LOGGER.debug("### EgovExcelServiceTest testModifyDocAttribute() End ");
    }
    ...
    public void testGetCellContents() throws IOException {
        LOGGER.debug("### EgovExcelServiceTest testGetCellContents() Start ");
        ...
        LOGGER.debug("### EgovExcelServiceTest testGetCellContents() End ");
    }
    ...
    public void testModifyCellAttribute() throws IOException {
        LOGGER.debug("### EgovExcelServiceTest testModifyCellAttribute() Start ");

        StringBuilder sb = new StringBuilder();
        sb.append(fileLocation).append("/").append("testModifyCellAttribute.xls");
        if (EgovFileUtil.isExistsFile(sb.toString())) {
            EgovFileUtil.delete(new File(sb.toString()));
            LOGGER.debug("### EgovExcelServiceTest testModifyCellAttribute() Delete File : {}", sb);
        }
        ...
        LOGGER.debug("### EgovExcelServiceTest testModifyCellAttribute() End ");
    }
    ...
    public void testUseTemplate1() throws IOException {
        LOGGER.debug("### EgovExcelServiceTest testUseTemplate1() Start ");

        StringBuilder sb = new StringBuilder().append(fileLocation).append("/template/").append("template1.xls");
        StringBuilder sbResult = new StringBuilder().append(fileLocation).append("/").append("testUseTemplate1.xls");
        ...
        LOGGER.debug("### EgovExcelServiceTest testUseTemplate1() End ");
    }
    ...
    public void testUseTemplate2() throws FileNotFoundException {
        LOGGER.debug("### EgovExcelServiceTest testUseTemplate2() Start ");

        StringBuilder sb = new StringBuilder().append(fileLocation).append("/template/").append("template2.xls");
        StringBuilder sbResult = new StringBuilder().append(fileLocation).append("/").append("testUseTemplate2.xls");
        ...
        LOGGER.debug("### EgovExcelServiceTest testUseTemplate2() End ");
    }
