...
public class EgovCryptoConfigBeanDefinitionParser extends AbstractSingleBeanDefinitionParser{
	...
	protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder bean) {
		...
		"\n" +
		"	<bean id=\"egovEnvPasswordEncoderService\" class=\"egovframework.rte.fdl.cryptography.EgovPasswordEncoder\">\n" + 
		"		<property name=\"algorithm\" value=\""+ algorithm +"\"/>\n" + 
		"		<property name=\"hashedPassword\" value=\"" + algorithmKeyHash +"\"/>\n" + 
		"	</bean>\n" + 
		"\n" + 
		"	<bean id=\"egovEnvARIACryptoService\" class=\"egovframework.rte.fdl.cryptography.impl.EgovARIACryptoServiceImpl\">\n" + 
		"		<property name=\"passwordEncoder\" ref=\"egovEnvPasswordEncoderService\"/>\n" + 
		"		<property name=\"blockSize\" value=\"" + cryptoBlockSize +"\"/>\n" + 
		"	</bean>\n" + 
		"\n" + 
		"<bean id=\"egovEnvCryptoConfigurerService\" class=\"egovframework.rte.fdl.property.impl.EgovPropertyServiceImpl\">\n" + //destroy-method=\"destroy\"
		...
		"</bean>\n" +
		"\n" + 
		"	<bean id=\"egovEnvCryptoService\" class=\"egovframework.rte.fdl.cryptography.impl.EgovEnvCryptoServiceImpl\" "+sCryptoInit+">\n" +
		"		<property name=\"passwordEncoder\" ref=\"egovEnvPasswordEncoderService\"/>\n" + 
