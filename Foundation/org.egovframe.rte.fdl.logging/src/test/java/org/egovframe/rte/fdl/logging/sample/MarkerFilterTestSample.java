...
public class MarkerFilterTestSample {
    ...
    public void doSelectUser(String userId) {
    ...
    public void doInsertUser(String userId) {
    ...
    public void doUpdateUser(String userId) {
    ...
    public void doDeleteUser(String userId) {
