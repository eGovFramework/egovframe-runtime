...
-- method ;
insert into secured_resources (resource_id, resource_name, resource_pattern, description, resource_type, sort_order, create_date) values ('mtd-000001', 'test_resource_1', 'org.egovframe.rte.fdl.security.web.CategoryController.selectCategoryList', '', 'method', 1, '2009-03-16');
--insert into secured_resources (resource_id, resource_name, resource_pattern, description, resource_type, sort_order, create_date) values ('mtd-000002', 'test_resource_2', 'org.egovframe.rte.fdl.security.service.EgovSampleService.deleteSample', '', 'method', 100, '2009-03-16');
insert into secured_resources (resource_id, resource_name, resource_pattern, description, resource_type, sort_order, create_date) values ('mtd-000003', 'test_resource_3', 'execution(* org.egovframe.rte.security..service.*Service.insert*(..))', '', 'pointcut', 1000, '2009-03-16');
