...
public class ServiceEndpointInterfaceInfoImpl implements ServiceEndpointInterfaceInfo {
     ...
     */
    public ServiceEndpointInterfaceInfoImpl(String namespace, String wsdlAddress, String serviceName, String portName, String operationName,
                                            ServiceParamInfo returnInfo, Collection<ServiceParamInfo> paramInfos) {
        super();
        if (!StringUtils.hasText(namespace)) {
            LOGGER.debug("ServiceEndpointInterfaceInfoImpl() Argument 'namespace' has no text ({})", namespace);
            throw new IllegalArgumentException();
        } else if (!StringUtils.hasText(wsdlAddress)) {
            LOGGER.debug("ServiceEndpointInterfaceInfoImpl() Argument 'wsdlAddress' has no text ({})", wsdlAddress);
            throw new IllegalArgumentException();
        } else if (!StringUtils.hasText(serviceName)) {
            LOGGER.debug("ServiceEndpointInterfaceInfoImpl() Argument 'serviceName' has no text ({})", serviceName);
            throw new IllegalArgumentException();
        } else if (!StringUtils.hasText(portName)) {
            LOGGER.debug("ServiceEndpointInterfaceInfoImpl() Argument 'portName' has no text ({})", portName);
            throw new IllegalArgumentException();
        } else if (!StringUtils.hasText(operationName)) {
            LOGGER.debug("ServiceEndpointInterfaceInfoImpl() Argument 'operationName' has no text ({})", operationName);
            throw new IllegalArgumentException();
        } else if (paramInfos == null) {
            LOGGER.debug("ServiceEndpointInterfaceInfoImpl() Argument 'paramInfos' is null");
            throw new IllegalArgumentException();
        }
     ...
     * Constructor
     *
     * @param webServiceClientDefinition WebServiceClientDefinition
     * @param requestType                Request Message RecordType
     * @param responseType               Response Message RecordType
     */
    public ServiceEndpointInterfaceInfoImpl(final WebServiceClientDefinition webServiceClientDefinition, final RecordType requestType, final RecordType responseType) {
        super();
        if (webServiceClientDefinition == null) {
            LOGGER.debug("### ServiceEndpointInterfaceInfoImpl Argument 'webServiceClientDefinition' is null");
            throw new IllegalArgumentException();
        } else if (!webServiceClientDefinition.isValid()) {
            LOGGER.debug("### ServiceEndpointInterfaceInfoImpl Argument 'webServiceClientDefinition' is invalid");
            throw new IllegalArgumentException();
        } else if (requestType == null) {
            LOGGER.debug("### ServiceEndpointInterfaceInfoImpl Argument 'requestType' is null");
            throw new IllegalArgumentException();
        } else if (responseType == null) {
            LOGGER.debug("### ServiceEndpointInterfaceInfoImpl Argument 'responseType' is null");
            throw new IllegalArgumentException();
        }
