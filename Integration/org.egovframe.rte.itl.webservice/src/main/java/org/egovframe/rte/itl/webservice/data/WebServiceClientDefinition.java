...
public class WebServiceClientDefinition implements Validatable {
     ...
     * @param requestMappingInfos  request mapping info
     * @param responseMappingInfos response mapping info
     */
     ...
     * requestMappingInfos
     *
     * @param requestMappingInfos the requestMappingInfos to set
     */
     ...
     * responseMappingInfos
     *
     * @param responseMappingInfos the responseMappingInfos to set
     */
    ...
    public String toString() {
        ...
        if (requestMappingInfos == null) {
            ...
            for (Entry<String, MappingInfo> entry : requestMappingInfos.entrySet()) {
                sb.append("\n\t\t<key = ").append(StringUtils.quote(entry.getKey())).append(", value = ").append(entry.getValue()).append(">");
            }
            sb.append("\n\t}");
        }
