...
public interface EgovWebServiceClassLoader {
     ...
     */
    String getFieldNameOfServiceBridge();
     ...
     * @param type type
     * @return Class 객체
     * @throws ClassNotFoundException <code>type</code>에 해당하는 Class를 생성할 수 없는 경우
     */
    Class<?> loadClass(final Type type) throws ClassNotFoundException;
     ...
     * @throws ClassNotFoundException class를 생성할 수 없을 경우
     */
    Class<?> loadClass(final ServiceEndpointInfo serviceEndpointInfo) throws ClassNotFoundException;
     ...
     */
    Class<?> loadClass(final ServiceEndpointInterfaceInfo serviceEndpointInterfaceInfo) throws ClassNotFoundException;
