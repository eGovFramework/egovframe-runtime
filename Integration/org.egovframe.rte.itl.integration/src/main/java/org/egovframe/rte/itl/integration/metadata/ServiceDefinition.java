...
public class ServiceDefinition implements Validatable {
     ...
     * @param id                    서비스 Id
     * @param name                  서비스 명
     * @param requestMessageTypeId  요청 메시지 Type Id
     * @param responseMessageTypeId 응답 메시지 Type Id
     * @param serviceProviderBeanId 서비스 제공 Bean Id
     * @param standard              표준 여부
     * @param using                 사용 여부
     */
     ...
     * 요청메시지 TypeId
     *
     * @param requestMessageTypeId the requestMessageTypeId to set
     */
     ...
     * 응답메시지 Type Id
     *
     * @param responseMessageTypeId the responseMessageTypeId to set
     */
     ...
     * 서비스 제공 Bean Id
     *
     * @param serviceProviderBeanId the serviceProviderBeanId to set
     */
