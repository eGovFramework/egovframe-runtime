...
public class RecordTypeDefinition implements Validatable {
     ...
     * @param id     id
     * @param name   name
     * @param parent 부모 <code>RecordTypeDefinition</code> 객체
     */
    public RecordTypeDefinition(String id, String name,
    ...
    public String toString() {
        ...
        sb.append(this.getClass().getName()).append(" {").append("\n\tid = ")
                ...
                .append(parent == null ? "null" : StringUtils.quote(parent.getId()))
                .append("\n\tfields = ").append(fields == null ? "null" : "[...]");
        sb.append("\n}");
        return sb.toString();
    }
