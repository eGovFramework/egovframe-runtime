...
public interface EgovIntegrationServiceCallback {
     ...
     *
     * @param service        연계 서비스
     * @param requestMessage 요청 메시지
     * @return Callback ID
     * @throws IllegalArgumentException Argument <code>service</code>,
     *                                  <code>requestMessage</code> 값이 <code>null</code> 인 경우
     */
    CallbackId createId(EgovIntegrationService service, EgovIntegrationMessage requestMessage);
     ...
     */
    void onReceive(CallbackId callbackId, EgovIntegrationMessage responseMessage);
