...
public interface EgovIntegrationMessageHeader {
     ...
     * 연계 Id를 setting한다.
     *
     * @param integrationId 연계 Id
     */
    void setIntegrationId(final String integrationId);
     ...
     * @return 제공 기관 Id
     */
    String getProviderOrganizationId();

    /**
     * 제공 기관 Id를 setting한다.
     *
     * @param providerOrganizationId 제공 기관 Id
     */
    void setProviderOrganizationId(final String providerOrganizationId);
     ...
     * @return 제공 시스템 Id
     */
    String getProviderSystemId();

    /**
     * 제공 시스템 Id를 setting한다.
     *
     * @param providerSystemId 제공 시스템 Id
     */
    void setProviderSystemId(final String providerSystemId);
     ...
     * @return 제공 서비스 Id
     */
    String getProviderServiceId();

    /**
     * 제공 서비스 Id를 setting한다.
     *
     * @param providerServiceId 제공 서비스 Id
     */
    void setProviderServiceId(final String providerServiceId);
     ...
     * @return 요청 기관 Id
     */
    String getConsumerOrganizationId();

    /**
     * 요청 기관 Id를 setting한다.
     *
     * @param consumerOrganizationId 요청 기관 Id
     */
    void setConsumerOrganizationId(final String consumerOrganizationId);
     ...
     * @return 요청 시스템 Id
     */
    String getConsumerSystemId();

    /**
     * 요청 시스템 Id를 setting한다.
     *
     * @param consumerSystemId 요청 시스템 Id
     */
    void setConsumerSystemId(final String consumerSystemId);
     ...
     * @return 요청 송신 시각
     */
    Calendar getRequestSendTime();

    /**
     * 요청 송신 시각을 setting한다.
     *
     * @param requestSendTime 요청 송신 시각
     */
    void setRequestSendTime(final Calendar requestSendTime);
     ...
     * 요청 수신 시각을 setting한다.
     *
     * @param requestReceiveTime 요청 수신 시각
     */
    void setRequestReceiveTime(final Calendar requestReceiveTime);
     ...
     * @return 응답 송신 시각
     */
    Calendar getResponseSendTime();

    /**
     * 응답 송신 시각을 setting한다.
     *
     * @param responseSendTime 응답 송신 시각
     */
    void setResponseSendTime(final Calendar responseSendTime);
     ...
     * @return 응답 수신 시각
     */
    Calendar getResponseReceiveTime();

    /**
     * 응답 수신 시각을 setting한다.
     *
     * @param responseReceiveTime 응답 수신 시각
     */
    void setResponseReceiveTime(final Calendar responseReceiveTime);
