...
public class IntegrationDefinition implements Validatable {
     ...
     *
     * @param id             연계 ID
     * @param provider       제공 서비스
     * @param consumer       요청 시스템
     * @param defaultTimeout default timeout
     * @param using          사용 여부
     * @param validateFrom   유효 기간 (시작)
     * @param validateTo     유효 기간 (끝)
     */
    ...
    public String toString() {
        ...
        sb.append(this.getClass().getName()).append(" {").append("\n\tid = ")
                ...
                .append("\n\tconsumer.key = ")
                .append(consumer == null ? "null" : StringUtils.quote(consumer.getKey()))
                .append("\n\tdefaultTimeout = ")
