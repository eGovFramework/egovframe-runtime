...
public class TypedMap implements Map<String, Object> {
     ...
     *
     * @param type type
     * @throws IllegalArgumentException Argument <code>type</code> 값이 <code>null</code>인 경우
     */
     ...
     * @param value value
     * @return 변환된 value
     * @throws NoSuchRecordFieldException <code>key</code>로 정의된 field가 없을 경우
     * @throws UnassignableValueException <code>key</code>로 정의된 Field에 <code>value</code> 값을 assign할 수
     *                                    없는 경우
     */
     ...
     *
     * @param map 값을 담고 있는 Map 객체
     * @return 변환된 값을 담고 있는 Map 객체
     * @throws NoSuchRecordFieldException Argument <code>map</code>이 담고 있는 값들 중 해당하는 field가 없을 경우
     * @throws UnassignableValueException <code>map</code>이 담고 있는 값들 중 해당하는 field에 assign할 수 없는 경우
     */
