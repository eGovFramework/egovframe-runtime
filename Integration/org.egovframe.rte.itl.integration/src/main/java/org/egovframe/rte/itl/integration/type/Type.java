...
public interface Type extends Validatable {
     ...
     * @throws UnassignableValueException Assign할 수 없는 값인 경우
     */
    Object convertToTypedObject(final Object source);
     ...
     */
    boolean isAssignableValue(final Object source);

    /**
     * Argument <code>clazz</code> 형식의 값을 assign할 수 있는지 알려준다.
     *
     * @param clazz assign할 Class
     * @return assign할 수 있으면 true, 그렇지 않으면 false
     * @throws IllegalArgumentException <code>clazz</code> 값이 <code>null</code> 인 경우
     */
