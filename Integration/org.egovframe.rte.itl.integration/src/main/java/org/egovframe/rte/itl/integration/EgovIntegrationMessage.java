...
public interface EgovIntegrationMessage {
     ...
     * 메시지 헤더를 setting한다.
     *
     * @param header 메시지 헤더 (not null)
     * @throws IllegalArgumentException Argument <code>header</code> 값이 <code>null</code>인 경우
     */
    void setHeader(final EgovIntegrationMessageHeader header);
     ...
     * 메시지 바디를 setting한다.
     *
     * @param body 메시지 바디 (not null)
     * @throws IllegalArgumentException Argument <code>body</code> 값이 <code>null</code>인 경우
     */
    void setBody(final Map<String, Object> body);
     ...
     * @throws IllegalArgumentException 1. Argument <code>name</code> 값이 <code>null</code>이거나 공백 문자로
     *                                  이루어져 있는 경우 <br>
     *                                  2. Argument <code>attachment</code> 값이 <code>null</code>인 경우
     */
    Object putAttachment(final String name, final Object attachment);
     ...
     */
    Object removeAttachment(final String name);
