...
public class SimpleMessage implements EgovIntegrationMessage {
     ...
     * @param header 메시지 헤더
     * @param body   메시지 바디
     * @throws IllegalArgumentException 1. Argument <code>header</code>, <code>body</code> 값이
     ...
     * @throws IllegalArgumentException 1. Argument <code>header</code>, <code>body</code>,
