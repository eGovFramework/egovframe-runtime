...
package egovframework.rte.psl.orm.ibatis.support;
 ...
 * @since 1.1.5
 * @see egovframework.rte.psl.orm.ibatis.SqlMapClientFactoryBean#setLobHandler
...
public class ClobStringTypeHandler extends AbstractLobTypeHandler {
	 ...
	 * @see egovframework.rte.psl.orm.ibatis.SqlMapClientFactoryBean#getConfigTimeLobHandler
	 */
