...
버전 **5.0.2** 기준 Maven 좌표는 `org.egovframe.rte:<artifactId>:5.0.2` 형태입니다. 상세 사용법은 일부 모듈(`/Foundation/.../README.md`)에 별도 문서가 있습니다.
...
**전자정부 표준프레임워크 런타임 5.0.2** - 공공기관 정보시스템 개발을 위한 표준화된 컴포넌트 제공
