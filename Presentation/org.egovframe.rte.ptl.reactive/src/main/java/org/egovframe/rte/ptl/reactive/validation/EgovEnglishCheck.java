...
@Constraint(validatedBy = EgovEnglishCheckValidation.class)
@Documented
public @interface EgovEnglishCheck {

    String message() default "{validation.englishCheck}"; // 유효성 검사 false시 반환할 기본 메시지
