...
@Constraint(validatedBy = EgovEmailCheckValidation.class)
@Documented
public @interface EgovEmailCheck {

    String message() default "{validation.emailCheck}"; // 유효성 검사 false시 반환할 기본 메시지
