...
@Constraint(validatedBy = EgovNullCheckValidation.class)
@Documented
public @interface EgovNullCheck {

    String message() default "Please enter required values"; // 유효성 검사 false시 반환할 기본 메시지
