...
@Constraint(validatedBy = EgovPhoneCheckValidation.class)
@Documented
public @interface EgovPhoneCheck {

    String message() default "{validation.phoneCheck}"; // 유효성 검사 false시 반환할 기본 메시지
